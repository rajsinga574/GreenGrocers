import type { KpiFilters, KpiData, Region, Store, Supplier, ItTicket, ItTicketStatus, Product, TopStoreData, Order, Forecast, SummaryView, StoreSalesSummary, ProductSalesSummary, DateSalesSummary } from '../types';
...
export const getKpiData = async (filters: KpiFilters): Promise<KpiData> => {
    ...
    let totalRevenue = 0;
    let totalQuantity = 0;
    let totalSpoiled = 0; // Simplified spoilage calculation
