...
const OrderPlacement: React.FC<OrderPlacementProps> = ({ showModal, onPlaceOrder }) => {
  ...
  const handleOrderPlacement = (event: React.FormEvent) => {
    ...
    showModal(
      ...
      `Order for **${product.name} (${orderQty} ${product.unit})** has been placed with **${selectedSupplier}** and synced with the ERP system.`
    );
  };
    ...
    <div className="bg-white p-6 rounded-xl shadow-lg">
      ...
      <form onSubmit={handleOrderPlacement}>
        ...
        <div className="mt-6 flex justify-end">
          <button type="submit" className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 px-6 rounded-lg shadow-md transition-colors duration-200">
            Submit Order
          </button>
        </div>
      </form>
