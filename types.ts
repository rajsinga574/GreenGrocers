export type Role = 'manager' | 'it-support' | 'leadership' | null;
export type Page = 'login' | 'order-placement' | 'order-history' | 'maintenance' | 'it-ticket-list' | 'kpi-dashboard' | 'forecast' | 'pos-data';
